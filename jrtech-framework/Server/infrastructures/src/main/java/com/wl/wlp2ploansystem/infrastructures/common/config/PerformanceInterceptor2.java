...
public class PerformanceInterceptor2 implements Interceptor {

    private static final Log logger = LogFactory.getLog(PerformanceInterceptor2.class);
    ...
    public PerformanceInterceptor2 setMaxTime(long maxTime) {
    ...
    public PerformanceInterceptor2 setFormat(boolean format) {
        this.format = format;
        return this;
    }
    ...
    public PerformanceInterceptor2 setWriteInLog(boolean writeInLog) {
