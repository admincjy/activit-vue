...
@TableName("base_attachment_category_classification")
public class Base_AttachmentCategoryClassification extends FullAuditedEntity implements ITreeObject {
        @Display("父编号")
        @NotBlank
        ...
        return "Base_AttachmentCategoryClassification";
    }
    }
